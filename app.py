...
# =====================================================
# PAGE TITLE (Always on top for Dashboard)
# =====================================================
...
# =====================================================
    ...
    st.markdown("Explore advanced trends, forecasting, and insights.")

    # Example: Trend over last months
    if "data" in locals():
        st.line_chart(data.groupby("Month")["Ref"].count())
        st.bar_chart(data.groupby("Technician Name")["Done Tasks"].sum())
    st.info("You can add forecasting, rolling averages, and other predictive KPIs here.")
...
# =====================================================
    ...
    st.markdown("Search, filter, and inspect raw ticket data.")
...
# =====================================================
    ...
    st.markdown("Download your processed data and monthly summaries.")
    ...
    if "data" in locals() and "monthly_summary" in locals():
        ...
        st.download_button("⬇️ Download Excel", excel_buffer, "analytics_report.xlsx")

        prs = create_ppt({"Monthly KPI": monthly_summary})
        ppt_buffer = BytesIO()
        prs.save(ppt_buffer)
        ppt_buffer.seek(0)
        st.download_button("⬇️ Download PowerPoint", ppt_buffer, "analytics_report.pptx")
...
# =====================================================
    ...
    st.title("⚙️ Settings")
    st.markdown("Toggle features and adjust preferences.")
