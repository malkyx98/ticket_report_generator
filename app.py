...
if not st.session_state.logged_in:
    login_ui()
    st.stop()  # Stop running the app below until logged in
...
if uploaded_file:
    ...
    st.dataframe(monthly_summary[[ 'Month','Total Tickets','Closed Tickets','Pending Tickets',
                                   'SLA Violations','SLA TTO Violations','SLA TTR Violations',
                                   'Closure %','SLA %','Avg Resolution Days']], use_container_width=True)
